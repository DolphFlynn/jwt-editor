...
class PEMToJWKTests {
    ...
    private static final String PRIME256v1Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String SECP256K1Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String SECP384R1Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String SECP521R1Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String X25519Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String RSA1024Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String RSA2048Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String RSA3072Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String RSA4096Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String ED448Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String ED25519Public = """
            -----BEGIN PUBLIC KEY-----
    ...
    private static final String X448Public = """
            -----BEGIN PUBLIC KEY-----
