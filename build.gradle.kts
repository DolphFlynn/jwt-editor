...
dependencies {
    "guiGenerationTask"("com.jetbrains.intellij.java:java-compiler-ant-tasks:253.31033.145")
    ...
    implementation("com.jetbrains.intellij.java:java-gui-forms-rt:253.31033.145")
