...
dependencies {
    "guiGenerationTask"("com.jetbrains.intellij.java:java-compiler-ant-tasks:253.30387.127")
    ...
    implementation("com.jetbrains.intellij.java:java-gui-forms-rt:253.30387.127")
