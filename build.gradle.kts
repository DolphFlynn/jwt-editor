...
dependencies {
    "guiGenerationTask"("com.jetbrains.intellij.java:java-compiler-ant-tasks:251.26927.74")
    ...
    implementation("com.jetbrains.intellij.java:java-gui-forms-rt:252.21158")
