...
dependencies {
    "guiGenerationTask"("com.jetbrains.intellij.java:java-compiler-ant-tasks:252.25557.131")
    ...
    implementation("com.jetbrains.intellij.java:java-gui-forms-rt:253.8964")
